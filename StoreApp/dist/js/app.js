...
$(window).scroll(function () {
    ...
    $('.last-sidebar').css('top', window_scrollTop);
...
$(".no-print").click(function (e) {
    e.preventDefault();
    //Enable sidebar push menu
    $("body").toggleClass('last-sidebar-open');
});
$(".content-wrapper").click(function () {
    //Enable hide menu when clicking on the content-wrapper on small screens    
    if ($(window).width() <= 767 && $("body").hasClass("last-sidebar-open")) {
        $("body").removeClass('last-sidebar-open');
    }
});
/* Tree()
 * ======
